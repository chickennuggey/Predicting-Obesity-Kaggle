...
# Load & Examine Structure of Data 
...
# Code to create imputated data, but I used kevin's so ignore the next few lines
...
#XtestNew <- read.csv("/Users/briannanguyen/Desktop/Xest_mice1", stringsAsFactors = TRUE) 
#XtestNew <- XtestNew[, -1]
...
figure <- annotate_figure(figure, top = text_grob("", face = "bold", size = 15))
figure
